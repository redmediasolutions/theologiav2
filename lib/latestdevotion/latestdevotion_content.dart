  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        /// DESCRIPTION
        if (_hasText(data['description']))
          DescriptionSection(description: data['description']),

        const SizedBox(height: 20),

        /// VERSE
        if (_hasText(data['verse']) && _hasText(data['verseReference']))
          VerseSection(
            verse: data['verse'],
        ...
        /// SONG
        if (_hasText(data['songTitle']) &&
            _hasText(data['songArtist']) &&
            _hasText(data['songurl'])) ...[
